        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Modifier le Slider: {{ $slider->titre }}</h4>
                    <div class="d-flex">
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('titre') is-invalid @enderror" 
                                           id="titre" name="titre" value="{{ old('titre', $slider->titre) }}" required>
                                    @error('titre')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('bouton_text') is-invalid @enderror" 
                                                   id="bouton_text" name="bouton_text" value="{{ old('bouton_text', $slider->bouton_text) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control @error('bouton_url') is-invalid @enderror" 
                                                   id="bouton_url" name="bouton_url" value="{{ old('bouton_url', $slider->bouton_url) }}"
                                                   placeholder="https://...">
                                            @error('bouton_url')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @if($slider->getFirstMediaUrl('slider'))
                                        <div class="mb-2">
                                            <img src="{{ $slider->getFirstMediaUrl('slider') }}" alt="{{ $slider->titre }}" 
                                    ...
                                    @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">Laissez vide pour conserver l'image actuelle. Formats acceptés: JPG, PNG, GIF (max 5MB)</div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('position') is-invalid @enderror" 
                                           id="position" name="position" value="{{ old('position', $slider->position) }}" min="1" required>
                                    @error('position')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('statut') is-invalid @enderror" id="statut" name="statut" required>
                                        <option value="active" {{ old('statut', $slider->statut) == 'active' ? 'selected' : '' }}>Actif</option>
                                        <option value="inactive" {{ old('statut', $slider->statut) == 'inactive' ? 'selected' : '' }}>Inactif</option>
                                    </select>
                                    @error('statut')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="border rounded p-3 text-center" style="min-height: 150px;">
                                        ...
                                        <div id="imagePlaceholder" class="text-muted">
                                            ...
                                            <p class="mt-2">Aperçu de la nouvelle image</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
