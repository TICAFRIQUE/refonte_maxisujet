...
@section('content')
                ...
                <div class="col-lg-6 fade-in-delay-3">
                    <div class="search-section">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="mt-2">
                                <a href="{{ route('sujet.front.index', ['search' => 'mathématiques']) }}" class="badge bg-light text-dark me-2">Mathématiques</a>
                                <a href="{{ route('sujet.front.index', ['search' => 'physique']) }}" class="badge bg-light text-dark me-2">Physique</a>
                                <a href="{{ route('sujet.front.index', ['search' => 'français']) }}" class="badge bg-light text-dark">Français</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="document-card h-100">
                            ...
                            <div class="document-preview">
                                ...
                                @elseif($preview)
                                    <img src="{{ $preview }}" alt="Aperçu" class="img-fluid" style="max-height: 150px; object-fit: cover;">
                                @else
                            ...
                            <div class="p-4">
                                ...
                                <p class="text-muted mb-3" style="min-height: 48px;">{{ Str::limit($sujet->description, 80) }}</p>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    @auth
                                        ...
                                        @endif
                                    @else
                                        <a href="{{ route('user.loginForm') }}" class="btn btn-outline-secondary rounded-pill">
    ...
    <!-- CTA Final -->
    <section class="py-5" style="background: linear-gradient(135deg, #ff6b35 0%, #f7931e 25%, #1e3a8a 75%, #0f172a 100%);">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
                        ...
                        <a href="{{ route('sujet.front.index') }}" class="btn btn-outline-light btn-lg px-5 py-3 rounded-pill">
